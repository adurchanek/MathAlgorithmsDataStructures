...
public class MainCanvas extends Object {
    ...
    private final int yDimension = InsertionSortView.dimensions.y;
    private final int xDimension = InsertionSortView.dimensions.x;
    private int P_SIZE = InsertionSortView.dimensions.x/110;
    ...
    private void sort() {
        ...
        animationSequence.add(new MoveInfo(nodes[0].val,  new Point(convertIndexToPosition(iSort + 1)), 1,1, false, false, true, false));
    ...
    public void init()
    {
        ...
        maxBlockHeight = InsertionSortView.dimensions.y*.5f;
        minBlockHeight = InsertionSortView.dimensions.y*.1f;
        size = 0;
        ...
        generalPaint.setShader(new LinearGradient(
                InsertionSortView.dimensions.x / 2f,
                InsertionSortView.dimensions.y / 2f,
                InsertionSortView.dimensions.x,
                InsertionSortView.dimensions.y,
                Color.rgb(180,255,0),
                Color.rgb(0,255,240),
    ...
    public void initNodes() {
        ...
        blockWidth = InsertionSortView.dimensions.x/ numNodes;
    ...
    public void moveNode(Node node, Point start,  Point end, int direction)
    {
        ...
        curveControlPoints.set(1, new Point(end.x + (start.x - end.x)/2, (int) (InsertionSortView.dimensions.y*.5f + direction*(InsertionSortView.dimensions.y*.35f + 3*((float)P_SIZE/ node.getScale().y) *InsertionSortView.dimensions.y*.5f))));
        curveControlPoints.set(2, new Point(end.x + (start.x - end.x)/2, (int) (InsertionSortView.dimensions.y*.5f + direction*(InsertionSortView.dimensions.y*.35f + 3*((float)P_SIZE/ node.getScale().y) *InsertionSortView.dimensions.y*.5f))));
    ...
    {
        Point p = new Point();
        p.y = InsertionSortView.dimensions.y/2;
