...
public class Node extends Object{
    ...
    public void update() {
        ...
        animatingStep++;
        if(InsertionSortView.mc.getProgressBarPercentage() == 0f)
        {
        ...
        if(currentAnimationIndex >= linePoints.length - 1)
        {
            ...
            if(InsertionSortView.mc.numberAnimating > 0)
            {
                InsertionSortView.mc.numberAnimating--;
            }
    ...
    public void init(int w, int h, int x, int y, int nNumber) {
        ...
        rectOutlinePaint.setColor(Color.RED);
