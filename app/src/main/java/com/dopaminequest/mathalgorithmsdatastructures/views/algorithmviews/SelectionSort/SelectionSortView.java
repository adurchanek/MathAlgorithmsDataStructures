...
public class SelectionSortView extends View implements Runnable{
    ...
    public SelectionSortView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
