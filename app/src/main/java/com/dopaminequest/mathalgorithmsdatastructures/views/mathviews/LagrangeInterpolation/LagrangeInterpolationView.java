...
public class LagrangeInterpolationView extends View implements Runnable{
    ...
    public LagrangeInterpolationView(Context context) {
        super(context);
    ...
    public LagrangeInterpolationView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public LagrangeInterpolationView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public LagrangeInterpolationView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
