...
public class DerivativeView extends View implements Runnable{
    ...
    public DerivativeView(Context context) {
        super(context);
    ...
    public DerivativeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public DerivativeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public DerivativeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
