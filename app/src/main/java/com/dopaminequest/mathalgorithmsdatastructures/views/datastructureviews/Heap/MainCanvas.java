...
public class MainCanvas extends Object {
    ...
    private Node currentlyAnimatingNode;
    ...
    public void createSortedList()
    {
        ...
        for(int i = 0; i < numNodes; i++)
        {
            ...
            nodes[i] = new Node((int) normalizedCircleDiameter, (int) ( minBlockHeight + blockHeight *(i)), p.x, (int) p.y, i+1, this);
            nodesCopyPreSort[i] = new Node((int) normalizedCircleDiameter, (int) ( minBlockHeight + blockHeight *(i)), p.x, (int) p.y, i+1, this);
        }
