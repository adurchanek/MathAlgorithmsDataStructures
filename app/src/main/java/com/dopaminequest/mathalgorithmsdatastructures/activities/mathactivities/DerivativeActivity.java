...
import com.dopaminequest.mathalgorithmsdatastructures.views.mathviews.Derivative.DerivativeView;

public class DerivativeActivity extends AppCompatActivity {

    private DerivativeView derivativeView;
    //Switch sw1;
    Switch sw2;
    SeekBar seekBar;
    Spinner spinner;
...
//        });
        ...
        sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    // The toggle is enabled
                    derivativeView.toggleAnimation();
                } else {
                    // The toggle is disabled
                    derivativeView.toggleAnimation();
                }
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                derivativeView.setFunctionNum(i);
            }
...
//                tvProgressLabel.setText("Progress: " + progress);
            derivativeView.setSeekPosition(progress);
            hValText.setText("h = " + String.format("%.2f",derivativeView.getHVal()));
